						...
						<div class="container">
							<div class="row">
								...
								<div class="4u 12u$(medium)">
									...
									языка, просто набирал команды и смотрел, что будет после их выполнения. Всё постигалось на практике.</p>
								</div>
								<div class="4u$ 12u$(medium)">
									<p>Затем мне купили первые мои книжки по программированию и понеслось ...
									Я сидел часами за компьютером. Когда меня отрывали от него, я ходил по всюду с тетрадью и шариковой ручкой в руках,
									записывая все свои идеи, чтобы позже проверить их на компьютере.</p>
								</div>
							</div>
						</div>
					</div>
			...
			<!-- Four -->
				<section id="four" class="wrapper style1 special fade-up">
					<div class="container">
						<header class="major">
							<h2>Мои увлечения</h2>
							<p>Я обожаю информационные технологии!</p>
						</header>
						<section id="content">
								<h3>Программирование</h3>
								<p>Программирование - самое первое и самое давнее моё хобби. Программированием я занимаюсь со школьных времён. Стараюсь не останавливаться на достигнутом, а всё время совершенствоваться, узнавать что-то новое, получать новый интересный опыт.
